...
$toemails[] = array(
    'email' => 'info@jawadamin.com', // Your Email Address
    'name' => 'Jawad Amin' // Your Name
);
...
$fromemail = array(
    'email' => 'noreply@jawadamin.com', // Company's Email Address (preferably currently used Domain Name)
    'name' => 'JawadAmin.com' // Company Name
);
...
$mail->IsSMTP();
$mail->Host = "mail.jawadamin.com";
$mail->SMTPDebug = 0;
$mail->SMTPAuth = true;
$mail->SMTPSecure = "rls";
$mail->Port = 587;
$mail->Username = "noreply@jawadamin.com";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $ar_footer = !empty($submits['ar_footer']) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong>Weeyz</strong>. All Rights Reserved.';

    $mail->Subject = !empty($submits['subject']) ? $submits['subject'] : 'Contact Inquiry Response from your Website';
    ...
    $html_before = '<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#eeeeee" style="width: 100%; height: 100%; padding: 50px 0 50px 0;">
				<tr>
					<td align="center" valign="top">
						<table border="0" cellpadding="0" cellspacing="0" width="75%" bgcolor="#ffffff" style="width: 84%;">
							<tr>
								<td align="center" valign="top">
									';
